...
class AlienInvasion:
	"""Overall class for assets and behaviour"""
	...
	def _check_events(self):
		"""Respond the key presses and mouse events"""
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			...
			# Get rid of any remaining aliens amd bullets
			self.aliens.empty()
			self.bullets.empty()
